...
protected:
	...
	PhysicsBodySpatial2D(Physics2DServer::BodyMode p_mode);
...
VARIANT_ENUM_CAST(RigidBodySpatial2D::Mode);
VARIANT_ENUM_CAST(RigidBodySpatial2D::CCDMode);

class KinematicBodySpatial2D : public PhysicsBodySpatial2D {
	GDCLASS(KinematicBodySpatial2D, PhysicsBodySpatial2D);
...
private:
	...
	Ref<KinematicCollisionSpatial2D> _move(const Vector2 &p_motion, bool p_infinite_inertia = true, bool p_exclude_raycast_shapes = true, bool p_test_only = false);
...
public:
	...
	KinematicBodySpatial2D();
	~KinematicBodySpatial2D();
};

VARIANT_ENUM_CAST(KinematicBodySpatial2D::MovingPlatformApplyVelocityOnLeave);

class KinematicCollisionSpatial2D : public Reference {
	GDCLASS(KinematicCollisionSpatial2D, Reference);

	KinematicBodySpatial2D *owner;
	friend class KinematicBodySpatial2D;
	KinematicBodySpatial2D::Collision collision;
